-- local vimrc = vim.fn.stdpath("config") .. "/init-old.vim"
...
These are for you, the reader to help understand what is happening. Feel free to delete them once 
you know what you're doing, but they should serve as a guide for when you are first encountering a 
few different constructs in your nvim config.
...
require("nvim-tree").setup {
  vim.keymap.set('n', "<leader>fb", ":NvimTreeOpen<CR>", {desc = '[F]ile [B]rowse'})
}
-------------------------------------------------------------------------------
-- [[ Configure Telescope ]]
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'gdscript', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim' },
